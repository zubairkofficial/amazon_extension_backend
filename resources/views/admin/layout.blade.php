...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dashboard/css/pagination.css') }}">
</head>
                        ...
                        <div class="nk-sidebar-content h-100" data-simplebar>
                            <div class="nk-sidebar-menu">
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="/admin/admins" class="nk-menu-link">
                                            <span class="nk-menu-icon">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="{{ route('selectors.index') }}" class="nk-menu-link">
                                            <span class="nk-menu-icon">
                                                <em class="icon ni ni-tag"></em>
                                            </span>
                                            <span class="nk-menu-text">Selectors</span>
                                        </a>
                                    </li>
                                    <li class="nk-menu-item">
